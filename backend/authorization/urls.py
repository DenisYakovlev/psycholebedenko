...
from .views import AuthWidgetTelegramUser, AuthBotAppTelegramUser, PhoneVerificationRetry, PhoneVerificationCheck, AuthBotAppSeamlessUser
...
urlpatterns = [
    ...
    path('telegram/seamless', AuthBotAppSeamlessUser.as_view()),
