...
export default function NavBar(){
    return (
        <Navbar sticky="top" expand="lg" bg="white" data-bs-theme="light" style={styles.navbar}>
            <Container fluid className="mx-lg-3 mx-1">
                ...
                <Navbar.Offcanvas style={styles.offcanvas} id="offcanvas" aria-labelledby="offcanvas-label" placement="start">
                    ...
                    <Offcanvas.Body as={Nav} variant="underline" className="justify-content-center flex-grow-1 pe-3 text-center">
