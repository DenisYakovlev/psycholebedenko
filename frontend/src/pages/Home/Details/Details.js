        ...
        <Container style={{backgroundColor: "#f4f4f4"}} className="m-0 p-0" fluid>
            <Row lg={4} sm={2} xs={1} style={{height: "fit-content", maxWidth: "1200px"}} className="m-0 py-5 mx-lg-auto">
                ...
                <DetailTag 
                    ...
                    text="Особистий індивідуальний підхід до кожного клієнта з урахуванням всіх потреб."
                />

                <DetailTag 
                    icon={faTag}
                    header="Доступність"
                    text="Розпочніть з безкоштовних групових зустрічей та запишіться на онлайн консультацію."
                />
            </Row>
        </Container>
    )
